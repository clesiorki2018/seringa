...
- [Arquitetura PlantUML](docs/arquitetura.puml)
- [Casos de Uso PlantUML](docs/casos-uso.puml)
- [Fluxo de Boot PlantUML](docs/fluxo-boot.puml)
- [Fluxo Login/Comando PlantUML](docs/fluxo-login-comando.puml)
- [Estados da Seringa PlantUML](docs/estados-seringa.puml)
